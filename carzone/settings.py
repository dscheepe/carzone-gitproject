...
SECRET_KEY = 'django-insecure-xnhv6@=%!u)6(gu3cc$i6yq#-a-&d7(ateduno0v3vd_ze#mnd'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'carzone_db', #de naam van de database
        'USER': 'postgres',  # de owner user waarmee de DB aangemaakt is
        'PASSWORD' : 'DiLi123!',
        'HOST': 'localhost', 
    }
}
